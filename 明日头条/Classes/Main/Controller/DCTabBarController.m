...
- (void)setupAllChildViewController {
    ...
    DCNavigationViewController *nav = [[DCNavigationViewController alloc]initWithRootViewController:essenceVc];
    [self addChildViewController:nav];
    DCNewViewController *newVc = [[DCNewViewController alloc]init];
    DCNavigationViewController *nav1 = [[DCNavigationViewController alloc]initWithRootViewController:newVc];
    ...
    DCNavigationViewController *nav3 = [[DCNavigationViewController alloc]initWithRootViewController:fsVc];
    [self addChildViewController:nav3];
    DCMeViewController *meVc = [[DCMeViewController alloc]init];
    DCNavigationViewController *nav4 = [[DCNavigationViewController alloc]initWithRootViewController:meVc];
